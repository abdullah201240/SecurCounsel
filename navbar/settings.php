...
<!-- End Navbar -->
  ...
  <h2 style="text-align: center;"class="font-weight-bolder mb-0">All Login device details</h2>
  <br>
</div>
    ...
    <table class="table table-dark">
      ...
      $sid=$_SESSION['student_id'];
                                ...
                                $s = "SELECT * FROM `logininfo` WHERE `sid`='$sid'";
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo"<a href='../dynamicdata.php'><button  type='button' class='btn btn-danger' style='text-align:left'>  Change Password!!</button></a>" ?></td>
